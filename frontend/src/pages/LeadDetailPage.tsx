...
export default function LeadDetailPage() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto h-[calc(100vh-64px)] overflow-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start h-auto lg:h-[calc(100%-48px)]">
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                <h1 className="text-2xl font-bold text-slate-900 mb-2 flex items-center gap-3">
                  {lead.nombre}
                  {lead.trabajador && (
                    <span className="text-xs uppercase font-bold text-slate-500 bg-slate-100 px-2 py-1 rounded">
